...
class Command(BaseCommand):
    help = _(u"Looks for very old bookmarks")
    ...
    def handle(self, *args, **options):
        ...
        old_bookmarks = Bookmark.objects.filter(create_date__lte=start_cut_off_date, create_date__gte=end_cut_off_date)
        for idx, ob in enumerate(old_bookmarks):
            print()
